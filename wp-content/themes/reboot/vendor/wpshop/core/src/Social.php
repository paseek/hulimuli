    ...
    public function share_buttons( $social_buttons = array(), $args = array() ) {
        ...
        foreach ( $social_buttons as $social_button ) :
            ...
            if ( $social_button == 'vkontakte' || $social_button == 'moimir' || $social_button == 'wordpress' ) {
                $attributes = ' data-image="' . esc_attr( $social_image_url[0] ) . '"';
            }

            if ( $social_button == 'pinterest' || $options['show_all_data'] ) {
                $attributes = ' data-url="' . $social_url . '" data-title="' . $social_title . '" data-description="' . $social_description . '" data-image="' . $social_image_url[0] . '"';
            }
    ...
    public function social_profiles( $profiles = array(), $pseudo_link = true, $display = true ) {
        ...
        foreach ( $profiles as $k => $profile ) {
            ...
            if ( $pseudo_link ) {
                ...
                $out .= '<span class="social-button social-button--' . $k . ' js-link" data-href="' . $profile . '" data-target="_blank"></span>';
            } else {
                $out .= '<a class="social-button social-button--' . $k . '" href="' . esc_attr( $profile ) . '" target="_blank"></a>';
            }
        }
