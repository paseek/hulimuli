 ...
 * Class Template
 *
 * 1.0.3    2021-01-22      add filter wpshop_core_remove_current_links:preserve_classes
 * 1.0.3    2020-04-13      add filter wpshop_core_views_counter__meta_field
 * 1.0.2    2019-04-22      add body_class_customizer
 * 1.0.1    2018-09-09      add get_views
 * 1.0.0    2018-09-08      init
 */
class Template {
    ...
    public function get_category( $args = array() ) {
        ...
        if ( $args['link'] ) {
            return '<a href="' . get_term_link( $cat_id ) . '"' . $micro_out . $classes_out . '>' . get_cat_name( $cat_id ) . '</a>';
        } else {
