...
$is_show_description_show = $wpshop_core->get_option( 'structure_archive_description_show' );
	...
	<div id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
                ...
                <?php if ( $is_show_description_show && 'top' == $wpshop_core->get_option( 'structure_archive_description' ) && ! is_paged() ) the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?>
			</header><!-- .page-header -->
            ...
            <?php if ( $is_show_description_show && 'bottom' == $wpshop_core->get_option( 'structure_archive_description' ) && ! is_paged() ) the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?>
